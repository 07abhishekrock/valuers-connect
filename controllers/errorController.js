...
//   console.log("EEEEErrrooorr  nnnnnaaaammmeee", err.name);
//   console.log("EEEEErrrooorr  ccccooodddee", err.statusCode);
...
const handleDuplicateFieldsDB = (err) => {
	...
	// const message = `Account With this Email Already Exist`;

	const message = `Account with ${value} already Exist. Please Try Again!`;
	return new AppError(message, 400);
};
